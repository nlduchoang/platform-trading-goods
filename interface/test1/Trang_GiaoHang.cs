...
namespace test1
{
    public partial class Trang_GiaoHang : Form
    {
        ...
        DataTable dt;
        SqlConnection conn;
        public Trang_GiaoHang()
        {
            InitializeComponent();
        }

        public Trang_GiaoHang(string taikhoan,string matkhau, string loainguoidung)
        {
            InitializeComponent();
        ...
        private void txtGiaohang_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd = new SqlCommand("VIEW_GIAOHANG_CUASHIPPER", conn);
